	...
	public static void main(String[] args) {
		...
		while(true){
			...
			case 1:
				...
				switch (option) {
				case 1:
					cart1.addItems("apple");
					break;
				case 2:
					cart2.addItems("apple");
					break;
				default:
					break;
				}
			...
			case 2:
				...
				switch (option) {
				case 1:
					cart1.addItems("flour");
					break;
				case 2:
					cart2.addItems("flour");
					break;
				default:
					break;
				}
			...
			case 4:
				...
				switch (option) {
				case 1:
					cart1.addItems("orange");
					break;
				case 2:
					cart2.addItems("orange");
					break;
				default:
					break;
				}
